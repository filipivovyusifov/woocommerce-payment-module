...
* Adds check for epay subscription id

= 3.1.4 =
* Changed epay Logo size and css

= 3.1.3 =
* Fix for using wrong Helper class

= 3.1.2 =
* Improved quality for ePay logo
* Improved quality for ePay payment type logos
...
= 3.0.0 =
* Module name changed from woocommerce-gateway-epay-dk to epay_dk
